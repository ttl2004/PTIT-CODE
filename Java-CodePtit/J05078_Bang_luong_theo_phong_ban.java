...
public class J05078_Bang_luong_theo_phong_ban {
    ...
    static class NV{
        ...
        public String toString() {
            return String.format("%s %s %d", id, name, luongThang);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        sc.nextLine();
        String x = mp1.get(sc.nextLine().trim()).name;
        
        System.out.println("Bang luong phong " + x + ":");
        
        for (NV y : list) {
            if (y.phongBan.equals(x)) System.out.println(y);
        }
    }
}
